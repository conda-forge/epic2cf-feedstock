About epic2cf-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/epic2cf-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5883&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/epic2cf-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `epic2cf` can be installed with `conda`:
...
```
mamba install epic2cf
```

It is possible to list all of the versions of `epic2cf` available on your platform with `conda`:
...
```
mamba search epic2cf --channel conda-forge
```
...
mamba repoquery search epic2cf --channel conda-forge

# List packages depending on `epic2cf`:
mamba repoquery whoneeds epic2cf --channel conda-forge

# List dependencies of `epic2cf`:
mamba repoquery depends epic2cf --channel conda-forge
```
